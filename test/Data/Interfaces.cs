...
namespace test.Classes
{
    class Interfaces
    {
        ...
        FrmCadastroLavanderia oFormCadLavanderia;
        FrmCadastroItensLavanderia oFormCadItensLavanderia;
        FrmCadastroCameras oFormCadCamera;
        FrmCadastroRamais oFormCadRamal;
        ...
        FrmConsultaLavanderia oFormConsLavanderia;
        FrmConsultaItensLavanderia oFormConsItensLavanderia;
        FrmConsultaCameras oFormConsCameras;
        FrmConsultaRamal oFormConsRamal;
        ...
        public Interfaces()
        {
            ...
            oFormCadLavanderia = new FrmCadastroLavanderia();
            oFormCadItensLavanderia = new FrmCadastroItensLavanderia();
            oFormCadCamera = new FrmCadastroCameras();
            oFormCadRamal = new FrmCadastroRamais();
            ...
            oFormConsLavanderia = new FrmConsultaLavanderia();
            oFormConsItensLavanderia = new FrmConsultaItensLavanderia();
            oFormConsCameras = new FrmConsultaCameras();
            oFormConsRamal = new FrmConsultaRamal();
            ...
            oFormConsLavanderia.SetFrmCadastro(oFormCadLavanderia);
            oFormConsItensLavanderia.SetFrmCadastro(oFormConsItensLavanderia);
            oFormConsRamal.SetFrmCadastro(oFormCadRamal);
            oFormConsCameras.SetFrmCadastro(oFormCadCamera);
            ...
            oFormCadLavanderia.SetConsultaItensLavanderia(oFormConsItensLavanderia);
        ...
        public void pecaForm(string tag)
        {
            ...
            switch (tag) // colocar todos os forms todos.
            {
                ...
                case "CAMERAS": PecaFormulario(oFormConsCameras, aCamera); break;
                case "RAMAIS": PecaFormulario(oFormConsRamal, oRamal); break;

                //GOVERNANÇA
                case "GOVERNANÇA": PecaFormulario(oFormConsControleGovFunc, aControleGov); break;
                case "LAVANDERIA": PecaFormulario(oFormConsLavanderia, aLavanderia); break;
                case "ITENS LAVANDERIA": PecaFormulario(oFormConsItensLavanderia, oItemLavanderia); break;
                ...
                case "REL. LAVANDERIA": Outros("REL. LAVANDERIA"); break;
        ...
        private void Outros(string Tipo)
        {
            switch (Tipo) // colocar todos os forms todos.
            {
                ...
                case "REL. ORDEM DE SERVIÇO":
                    ...
                    break;
                 case "REL. LAVANDERIA":
                    FrmRelLavanderia frmLav = new FrmRelLavanderia();
                    frmLav.Show();
                    break;
